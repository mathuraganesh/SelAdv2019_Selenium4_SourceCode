...
import org.openqa.selenium.devtools.Target.TargetInfo;
...
public class DevTools implements Closeable {
  ...
  public  Target.SessionId getSessionId() {
	  return cdpSession;
  }
  ...
  public void createSession() {
    ...
    System.out.println("Number of Target:"+ infos.size());
    for (TargetInfo targetInfo : infos) {
		System.out.println(targetInfo.getTitle()); // who are the target?
	}
