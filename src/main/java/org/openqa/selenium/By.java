...
public abstract class By {
   ...
   * @return A By which locates elements by CSS.
   */
  public static By near(String elementType, String label) {
    return new ByNear(elementType, label);
  }
  ...
  public static class ByNear extends By implements Serializable {
	    ...
	    public ByNear(String elementType, String label) {
	      if (elementType == null || label == null) {
	        throw new IllegalArgumentException(
	            "Cannot find elements when the element type or label is null.");
	      }

	      this.locatorExpression = "//*[text()='"+label+"']/following::"+elementType+"[1]";
	    }

	    @SuppressWarnings("deprecation")
		@Override
	    public List<WebElement> findElements(SearchContext context) {
	      return ((FindsByXPath) context).findElementsByXPath(locatorExpression);
	    }

	    @SuppressWarnings("deprecation")
		@Override
	    public WebElement findElement(SearchContext context) {
	      return ((FindsByXPath) context).findElementByXPath(locatorExpression);
	    }
  ...
  public static class ByAbove extends By implements Serializable {
	    ...
	    public ByAbove(String elementType, String label) {
	      if (elementType == null || label == null) {
	        throw new IllegalArgumentException(
	            "Cannot find elements when the element type or label is null.");
	      }

	      this.locatorExpression = "//*[text()='"+label+"']/preceding::"+elementType+"[1]";
	    }
